...
test_that("classification column added to the output", {
  actual <- rFunction(data = test_data %>% dplyr::slice(1:3000), cap_status = "winter", nest_coords = NULL, single_blk_merge = TRUE, gr_speed = FALSE, bursts_rec = FALSE,
...
test_that("missing input or invalid input combinations", {
  ...
  expect_error(
    rFunction(data = test_data %>% dplyr::slice(1:3000), cap_status = NULL, nest_coords = NULL, single_blk_merge = TRUE, gr_speed = FALSE, bursts_rec = FALSE,
              max_flight_sp = 40, dst_stat_gap = 30, time_stat_gap = 3, centr_dist = 50, near_blk_dist = 20, near_stop_rec = 1, 
              near_stat_dist = 5, clust_min_rec = 2, br_win_min = 30),
  ...
  expect_error(
    rFunction(data = test_data %>% dplyr::slice(1:3000), cap_status = "winter", nest_coords = c(Long = 2.3593, Lat = 48.8415), single_blk_merge = TRUE, gr_speed = FALSE, bursts_rec = FALSE,
              max_flight_sp = 40, dst_stat_gap = 30, time_stat_gap = 3, centr_dist = 50, near_blk_dist = 20, near_stop_rec = 1, 
              near_stat_dist = 5, clust_min_rec = 2, br_win_min = 30),
  ...
  expect_error(
    rFunction(data = test_data %>% dplyr::slice(1:3000), cap_status = "wintering", nest_coords = NULL, single_blk_merge = TRUE, gr_speed = FALSE, bursts_rec = FALSE,
              max_flight_sp = 40, dst_stat_gap = 30, time_stat_gap = 3, centr_dist = 50, near_blk_dist = 20, near_stop_rec = 1, 
              near_stat_dist = 5, clust_min_rec = 2, br_win_min = 30),
  ...
  # bursts not relevant
  expect_error(
    rFunction(data = test_data %>% dplyr::slice(1:3000), cap_status = "winter", nest_coords = NULL, single_blk_merge = TRUE, gr_speed = FALSE, bursts_rec = TRUE,
              max_flight_sp = 40, dst_stat_gap = 30, time_stat_gap = 3, centr_dist = 50, near_blk_dist = 20, near_stop_rec = 1, 
              near_stat_dist = 5, clust_min_rec = 2, br_win_min = 30),
  ...
  expect_error(
    rFunction(data = test_data %>% dplyr::slice(1:3000), cap_status = "winter", nest_coords = NULL, single_blk_merge = TRUE, gr_speed = FALSE, bursts_rec = FALSE,
              max_flight_sp = 40, dst_stat_gap = 30, time_stat_gap = 3, centr_dist = 50, near_blk_dist = 20, near_stop_rec = 1, 
  ...
  expect_error(
    rFunction(data = test_data %>% dplyr::slice(1:3000) %>% select(-any_of("ground_speed")), cap_status = "winter", nest_coords = NULL, single_blk_merge = TRUE, gr_speed = TRUE, bursts_rec = FALSE,
              max_flight_sp = 40, dst_stat_gap = 30, time_stat_gap = 3, centr_dist = 50, near_blk_dist = 20, near_stop_rec = 1, 
              near_stat_dist = 5, clust_min_rec = 2, br_win_min = 30),
